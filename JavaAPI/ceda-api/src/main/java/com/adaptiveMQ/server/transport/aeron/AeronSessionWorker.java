...
/**
 * This is a common workflow to {@link io.aeron.archive.Session} handling in the archive. Hooks are provided for specialisation as
 * protected methods.
 *
 * @param <T> session type
 */
class AeronSessionWorker<T extends AeronSession> implements Agent
{
    ...
    AeronSessionWorker(final String roleName, final CountedErrorHandler errorHandler)
    {
